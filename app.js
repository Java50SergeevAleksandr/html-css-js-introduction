...
console.log(comp1.addEmployee(employees[0]));
console.log(comp1.addEmployee(employees[1]));
console.log(comp1.addEmployee(employees[2]));
console.log(comp1.addEmployee(employees[4]));
console.log(comp1.addEmployee(employees[1]));
console.log(comp1.getEmployeesCountry("Israel"));
console.log(comp1.getEmployeesByAge(23));
console.log(comp1.getEmployeesBySalaries(15500, 16000));
console.log(comp1.getEmployeesBySalaries(-1, 16000));
console.log(comp1.getEmployeesBySalaries(15500, -1));
console.log(comp1.getEmployeesBySalaries(-1, -1));
console.log(comp1.removeEmployee(employees[1].id));
console.log(comp1.removeEmployee(employees[1].id));
console.log(comp1.removeEmployee(employees[1].id));
